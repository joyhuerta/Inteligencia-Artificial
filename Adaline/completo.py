...
plt.scatter(X[:50, 0], X[:50, 1],
            color='green', marker='o', label='Edad')
plt.scatter(X[50:100, 0], X[50:100, 1],
            color='gold', marker='x', label='Adulto')
...
def plot_decision_regions(X, y, classifier, resolution=0.02):
    ...
    markers = ('s', 'x', 'o', '^', 'v')
    colors = [(0.63, 0.79, 0.95), #babyblueeyes
              (0.8,0.0,0.0), #bostonred
              (0.76,0.58,0.89), #brigthlavander 
              (0.6,1.0,0.6), #mint
...
ax[0].set_xlabel('Menor')
ax[0].set_ylabel('Mayor')
ax[0].set_title('Adaline - Learning rate 0.01')

ada2 = AdalineGD(n_iter=10, eta=0.0001).fit(X, y)
ax[1].plot(range(1, len(ada2.cost_) + 1), ada2.cost_, marker='o')
ax[1].set_xlabel('Menor')
ax[1].set_ylabel('Mayor')
